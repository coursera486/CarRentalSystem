...
$(document).on('click', '.update-setting-btn', function() {
    ...
    $.ajax({
        ...
        contentType: false,
        processData: false,
         url: "<?php echo e(url('admin/settings/update')); ?>",
...
</script><?php /**PATH C:\xampp\htdocs\cars\CarRental\CarRentalSystem\resources\views/modal/updateSetting.blade.php ENDPATH**/ ?>