...
<head>
    ...
    <title>Admin Login - Online Car Rental System</title>
  ...
  <!-- BEGIN: Body-->
  <body class="vertical-layout vertical-menu-modern 1-column  navbar-sticky footer-static blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column" style="background-color:#190e27">
    <!-- BEGIN: Content-->
...
</html><?php /**PATH C:\xampp\htdocs\CarRentalSystem\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>