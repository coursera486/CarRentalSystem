                  ...
                  <div class="row p-4">
                    <form class="row gy-3 gy-xxl-4" id="profileForm">
                      ...
                      <div class="col-12 col-md-6 mb-3">
                        ...
                        <input type="tel" class="form-control" id="city" name="city" value="<?php echo e($user->city); ?>">
                      </div>
                      <div class="col-12 col-md-6 mb-3">
                        <label class="form-label"><b>Pincode</b><span class="text-danger">*</span></label>
                        <input type="email" class="form-control" id="pincode" name="pincode" value="<?php echo e($user->pincode); ?>">
                      </div>
                      <div class="col-12 col-md-6 mb-3">
                        <label class="form-label"><b>Date of birth</b><span class="text-danger">*</span></label>
                        <input type="date" class="form-control" id="dob" name="dob" value="<?php echo e($user->dob); ?>">
                      </div>
                      <div class="col-12 col-md-6 mb-3">
                      ...
                      <div class="col-12 col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="driving_license" name="driving_license" value="<?php echo e($user->driving_license); ?>">
                      </div>
                      <div class="col-12 col-md-6 mb-3">
                        <label class="form-label"><b>Aadhar number</b><span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="aadhar" name="aadhar" value="<?php echo e($user->aadhar); ?>">
                      </div>
                      <div class="col-12">
                        <label class="form-label"><b>About</b></label>
                        <textarea class="form-control" id="about" name="about"><?php echo e($user->about); ?></textarea>
                      </div>
                      <div class="col-12 col-md-6 mb-3 mt-4">
                        <label class="col-12 form-label">Profile Image</label>
                        <img src="<?php echo e(url('uploads/profile/'.$user->image)); ?>" class="img-fluid">
  ...
  $(document).ready(function() {
    $(document).on("click", ".submit_profile", function(event) {
      ...
      $.ajax({
        type: "post",
        data: formData,
        url: "<?php echo e(route('save_profile')); ?>",
        cache: false,
        contentType: false,
        processData: false,
...
</html><?php /**PATH C:\xampp\htdocs\CarRentalSystem\resources\views/profile.blade.php ENDPATH**/ ?>