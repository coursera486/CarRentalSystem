      ...
      <div class="card widget-card border-light shadow-sm">
        ...
        <div class="card-body">
          <div class="text-center mb-3">
            ...
            <img src="<?php echo e(url('uploads/profile/'.$user->image)); ?>" class="img-fluid rounded-circle" style="height:80px; width:80px;">
            <?php else: ?>
            <img src="<?php echo e(url('img/profileImage.png')); ?>" class="img-fluid rounded-circle" style="height:80px; width:80px;">
            <?php endif; ?>
          </div>
          ...
          <div class="d-grid m-0">
            <a href="<?php echo e(route('new_booking')); ?>"><button class="btn btn-outline-primary" type="button">New Booking</button></a>
          </div>
        </div>
      </div>
    </div>
...
</div><?php /**PATH C:\xampp\htdocs\CarRentalSystem\resources\views/user/sideDetails.blade.php ENDPATH**/ ?>