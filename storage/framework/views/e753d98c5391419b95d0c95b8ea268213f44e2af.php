...
<body>
<?php echo $__env->make('userAuthHeader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<section class="">
  
  <!-- <div class="container"> -->
  <div class="p-4 bg-light">
    <div class="row">
     <?php echo $__env->make('sideDetails', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          ...
          <div class="card-body p-4">
            <div class="tab-content" id="profileTabContent">
              <div class="tab-pane fade show active" id="overview-tab-pane" role="tabpanel" aria-labelledby="overview-tab" tabindex="0">
                ...
                <div class="row">
                <h3 class="display-4 text-uppercase mb-5 pl-3"><?php echo e($car->car_make); ?> - <?php echo e($car->car_model); ?></h3>
                <div class="col-lg-12 mb-5 see_details">
                    <div class="row mx-n2 mb-3">
                        ...
                        <div class="col-md-3 col-6 px-2 pb-2 image-container">
                            <img class="img-fluid w-100 h-100" style="height:50px; width:50px;" src="<?php echo e(url('uploads/images/'.$image->image)); ?>" alt="">
                        </div>
                            ...
                            <div class="form-group">
                                <div class="date" id="date1" data-target-input="nearest">
                                    ...
                                    <input type="date" class="form-control p-4 datetimepicker-input" placeholder="Pickup Date"
                                        data-target="#date1" data-toggle="datetimepicker" name="pickup_date" id="pickup_date"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="time" id="time1" data-target-input="nearest">
                                    ...
                                    <input type="time" class="form-control p-4 datetimepicker-input" placeholder="Pickup Time"
                                        data-target="#time1" data-toggle="datetimepicker" name="pickup_time" id="pickup_time"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="date" id="date1" data-target-input="nearest">
                                    ...
                                    <input type="date" class="form-control p-4 datetimepicker-input" placeholder="Drop Date"
                                        data-target="#date1" data-toggle="datetimepicker" name="drop_date" id="drop_date"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="time" id="time1" data-target-input="nearest">
                                    <label class="form-control-label text-white">Drop Time<span class="text-danger">*</span></label>
                                    <input type="time" class="form-control p-4 datetimepicker-input" placeholder="Drop Time"
                                        data-target="#time1" data-toggle="datetimepicker" name="drop_time" id="drop_time"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="time" id="time1" data-target-input="nearest">
                                    <label class="form-control-label text-white">Hours<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control p-4 datetimepicker-input" placeholder="Hours"
                                        data-target="#time1" data-toggle="datetimepicker" name="hours" id="hours" readonly/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="time" id="time1" data-target-input="nearest">
                                    <label class="form-control-label text-white">Rent Price<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control p-4 datetimepicker-input" placeholder="Rent Price"
                                        data-target="#time1" data-toggle="datetimepicker" name="rent_price" id="rent_price" readonly/>
                                </div>
                            </div>
                            <div class="form-group">
        ...
        $(document).on('change', '#pickup_date, #pickup_time, #drop_date, #drop_time', function() {
            ...
            if(pickup_date != '' && pickup_time != '' && drop_date != '' && drop_time != ''){
                ...
                $.get("<?php echo e(route('get_price')); ?>", {
                    car_id, pickup_date, pickup_time, drop_date, drop_time
                }, function(data) {
                    if(data.status == true){
...
</html><?php /**PATH C:\xampp\htdocs\CarRentalSystem\resources\views/car_book.blade.php ENDPATH**/ ?>