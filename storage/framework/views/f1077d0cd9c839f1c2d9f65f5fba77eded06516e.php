...
bxs-dashboard" data-icon="envelope-pull"></i><span class="menu-title text-truncate" data-i18n="Email">Dashboard</span></a>
          ...
          <li class="nav-item <?php if (request()->path() == 'admin/users') { 
                                    echo 'active';
                                } ?>"><a href="<?php echo e(url('/admin/users')); ?>"><i class="ficon bx bxs-group" data-icon="check-alt"></i><span class="menu-title text-truncate" data-i18n="Todo">Users</span></a>
          </li>
          
          <li class="nav-item <?php if (request()->path() == 'admin/notifications') { 
                                    echo 'active';
                                } ?>"><a href="<?php echo e(url('/admin/notifications')); ?>"><i class="ficon bx bxs-bell" data-icon="check-alt"></i><span class="menu-title text-truncate" data-i18n="Todo">Notification</span></a>
          </li>

          <li class="nav-item <?php if (request()->path() == 'admin/settings') {
                                    echo 'active';
                                } ?>"><a href="<?php echo e(url('/admin/settings')); ?>"><i class="ficon bx bxs-wrench" data-icon="check-alt"></i><span class="menu-title text-truncate" data-i18n="Todo">Settings</span></a>
          </li>

        </ul>
      </div>
    </div>
    <!-- END: Main Menu--><?php /**PATH C:\xampp\htdocs\cars\CarRental\CarRentalSystem\resources\views/layouts/header.blade.php ENDPATH**/ ?>