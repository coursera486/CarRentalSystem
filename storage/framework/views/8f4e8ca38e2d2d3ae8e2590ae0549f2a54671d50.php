...
<?php echo $__env->make('modal.updateSetting', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<script>
$(document).ready( function () {
    ...
    //     processing: true,
    //     ordering: false,
    //     ajax: "<?php echo e(url('admin/settings/data')); ?>",
    //     "aoColumns": [
    //         {
    //             mData: 'key'
    //         },
...
</html><?php /**PATH C:\xampp\htdocs\cars\CarRental\CarRentalSystem\resources\views/admin/settings.blade.php ENDPATH**/ ?>