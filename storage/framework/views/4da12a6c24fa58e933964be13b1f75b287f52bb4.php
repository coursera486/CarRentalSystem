<!-- BEGIN: Footer-->
    ...
    <script src="<?php echo e(asset('app-assets/vendors/js/extensions/dragula.min.js')); ?>"></script>
    <!-- END: Page Vendor JS-->
    ...
    <?php echo $__env->make('modal/admin_password_change', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <script>
    ...
    </script><?php /**PATH C:\xampp\htdocs\cars\CarRental\CarRentalSystem\resources\views/layouts/footer.blade.php ENDPATH**/ ?>