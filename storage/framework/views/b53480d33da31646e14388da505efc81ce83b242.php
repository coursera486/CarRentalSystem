...
<head>
    ...
    <title>Home - Online Car Rental System</title>
                    ...
                    <div class="row pt-1 pl-1 pr-1">
                      ...
                      <div class="col-xl-8 col-lg-8 col-md-8 col-12 float-right">
                        <div class="form-group position-relative has-icon-left float-right">
                          <input type="text" class="form-control daterange-filter" id="user-analytics-date-range" placeholder="Select Date" value="<?php echo e(date('d/m/Y',strtotime('-7 days'))); ?> - <?php echo e(date('d/m/Y')); ?>" autocomplete="off" style="width: 250px;"> 
...
<script src="<?php echo e(asset('app-assets/js/scripts/pages/dashboard-analytics.min.js')); ?>"></script>
</body>
</html>
<script>
...
</script><?php /**PATH C:\xampp\htdocs\CarRentalSystem\resources\views/admin/home.blade.php ENDPATH**/ ?>