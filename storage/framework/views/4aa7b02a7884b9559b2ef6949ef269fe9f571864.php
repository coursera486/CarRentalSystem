...
$(document).ready( function () {
  ...
  $(document).on('click', '#password_change_modal .update-password-btn', function() {
    ...
    $.ajax({
              type: "post",
              url: "<?php echo e(url('admin/password/update')); ?>",
...
<?php /**PATH C:\xampp\htdocs\cars\CarRental\CarRentalSystem\resources\views/modal/admin_password_change.blade.php ENDPATH**/ ?>