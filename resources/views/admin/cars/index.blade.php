                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-1">
                                            ...
                                            <div class="float-right ml-2">
                                                <a id="add_car" href="{{ route('admin.add_new_car') }}" class="btn btn-sm btn-primary">Add New Car</a>
                                            </div>
                                        </div>
                                        <div class="col-12">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.deactivate-car-btn', function() {
                ...
                $.confirm({
                    ...
                    buttons: {
                        yes: function() {
                            $.get("{{ route('admin.car_deactivate') }}", {
                                id
                            }, function(data) {
                                if (data.status == true) {
                                    Toast.fire({
