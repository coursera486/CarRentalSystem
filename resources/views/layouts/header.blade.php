          ...
          <!-- <li class="nav-item"><a href="#"><i class="bx bx-list-ul"></i><span class="">Cars</span></a> -->
            <!-- <ul class="menu-content"> -->
              ...
              <li class="nav-item <?php if (request()->path() == 'admin/add_new_car') { 
                                      echo 'active';
                                  } ?>"><a href="{{url('/admin/add_new_car')}}"><i class="ficon bx bxs-car" data-icon="check-alt"></i><span class="menu-title text-truncate" data-i18n="Todo">Add New Car</span></a>
              </li>

            <li class="nav-item <?php if (request()->path() == 'admin/car_list') { 
                                      echo 'active';
                                  } ?>"><a href="{{url('/admin/car_list')}}"><i class="bx bx-list-ul" data-icon="check-alt"></i><span class="menu-title text-truncate" data-i18n="Todo">Cars List</span></a>
            </li>
            <!-- </ul> -->
          <!-- </li> -->
          <li class="nav-item <?php if (request()->path() == 'admin/users') { 
                                    echo 'active';
                                } ?>"><a href="{{url('/admin/users')}}"><i class="ficon bx bxs-group" data-icon="check-alt"></i><span class="menu-title text-truncate" data-i18n="Todo">Customers</span></a>
          </li>
        

          <li class="nav-item <?php if (request()->path() == 'admin/bookings') {
                                    echo 'active';
                                } ?>"><a href="{{url('/admin/bookings')}}"><i class="ficon bx bx-list-check" data-icon="check-alt"></i><span class="menu-title text-truncate" data-i18n="Todo">Bookings</span></a>
          </li>

          <li class="nav-item <?php if (request()->path() == 'admin/reports') {
                                    echo 'active';
                                } ?>"><a href="{{url('/admin/reports')}}"><i class="bx bx-spreadsheet" data-icon="check-alt"></i><span class="menu-title text-truncate" data-i18n="Todo">Reports</span></a>
          </li>
